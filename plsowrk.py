...
app = dash.Dash(name='app1', url_base_pathname='/app1/', server=server)
...
login_app = dash.Dash(name='login-app', url_base_pathname='/login/', server=server)
...
logout_app = dash.Dash(name='logout-app', url_base_pathname='/logout/', server=server)
